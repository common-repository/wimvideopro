angular.module("wimtvApp").directive("countryPicker", ["$compile", function ($compile) {
	var countries = [
	...
	return {
		...
		compile: function (element, attributes) {
			if(! attributes.countryPicker) {
				attributes.countryPicker = 'alpha2';
			}
			var ngOptions = 'country.' + attributes.countryPicker + ' as country.name for country in countries';
			attributes.$set('ngOptions',  ngOptions);
